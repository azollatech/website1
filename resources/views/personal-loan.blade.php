...
@section('content')
	@include('partials.header-banner', ["image"=>"banner-3-darken.jpg", "title"=>"私人貸款"])
            ...
            <div class="mb-5">
                <div class="row">
                    ...
                    <div class="d-block col-md-9 col-lg-8" style="font-size: 1rem;">
                        <div>
                            <h2 style="text-align: left;" data-fontsize="34" data-lineheight="50">私人貸款</h2>
                        </div>
                        ...
                        <div class="mb-4">
							<div class="row">
								<div class="col-7">
									<p>私人貸款服務配合不同人士需要，申請貸款從未如此輕鬆簡單。我們為客戶提供全面的財務管理方案更可享低息及長還款期，讓您可靈活理財。</p>
		                            <ul>
										<li class="mb-3">還款期長達48個月</li>
										<li class="mb-3">申請費用全免</li>
										<li class="mb-3">貸款額高達月薪10倍</li>
										<li class="mb-3">最快 60分鐘現金到手</li>
									</ul>
								</div>
								<div class="col-5">
									<img src="{{asset('img/personal-loan-pic.jpg')}}" style="width: 100%">
								</div>
							</div>
                        </div>
                    </div>
