                    ...
                    <div class="col-10" style="font-size: 1rem;">
						...
						<div class="tab-content" id="nav-tabContent">
							<div class="tab-pane fade show active" id="nav-iva" role="tabpanel" aria-labelledby="nav-iva-tab">
								...
								<div class="mb-4">
									<h5 class="mb-5" style="font-size: 1.3rem;">IVA與破產比較表</h5>
									<div class="row" style="font-size: 0.9rem;">
										<div class="col-6 pb-4 mb-4" style="border-bottom: 1px solid #ccc;"><b>IVA《個人自願安排》</b></div>
										<div class="col-6 pb-4 mb-4" style="border-bottom: 1px solid #ccc;"><b>《個人破產》</b></div>
							...
							<div class="tab-pane fade" id="nav-drp" role="tabpanel" aria-labelledby="nav-drp-tab">
								...
								<h5 class="mb-4" style="text-decoration: underline;">DRP債務舒緩計劃好處</h5>
								<ul>
									<li><b>避免破產 - </b>申請人可以避免破產及不需要透過法律程序。</li>
									<li><b>減低利息 - </b>減少大部份利息開支，從而減低每月供款金額。</li>
									<li><b>可保留部份信用卡 - </b>DRP獨立向個別債權人商討還款協議，可重組部份債項。</li>
									<li><b>現職不受影響 - </b>不需要通知僱主，適合所有人士包括敏感行業。</li>
								</ul>
							</div>
							<div class="mb-5 mt-5">
								<p>經我們申請成功的客戶，可幫你在還款協議上，爭取長達至72期的還款期數，以及每月低至0%-1%的還款利息。如符合銀行審批資格，我們更可為你爭取最長可達96期的還款期數，以及每月更低至0-1%的還款利息。</p>
								<p>我們會為客戶設定每月供款只佔月薪的55%以下，不再陷入負現金流狀況，亦有基本生活質素。</p>
								<p>我們豁免所有咨詢費、會面費，費用只由客戶成功申請債務舒緩方案後才收取費用，不會增加你財政上的負擔！</p>
							</div>
						</div>
						<div class="mb-2">&nbsp;</div>
                    </div>
